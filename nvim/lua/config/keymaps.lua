...
-- nmap("n", "<C-Left>", ":wincmd h<CR>", { desc = "Go To Left Split" })
-- nmap("n", "<C-Down>", ":wincmd j<CR>", { desc = "Go To Bottom Split" })
-- nmap("n", "<C-Up>", ":wincmd k<CR>", { desc = "Go To Top Split" })
-- nmap("n", "<C-Right>", ":wincmd l<CR>", { desc = "Go To Right Split" })
